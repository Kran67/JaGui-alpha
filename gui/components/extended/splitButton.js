(function(){
  //#region SplitButton
  var SplitButton=$j.classes.ThemedControl.extend({
    _ClassName:"SplitButton",
  ...
  //#region Templates
  var SplitButtonTpl=["<div id='{internalId}' data-name='{name}' data-class='SplitButton' style='{style}' class='SplitButton' data-theme='{theme}'>",

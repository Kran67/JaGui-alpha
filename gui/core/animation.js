(function() {
  //#region Animations
  var Animations={
    interpolateSingle:function Animations_interpolateSingle(s,s1,t) {
      if (typeof s!==_const.NUMBER) s=0;
      if (typeof s1!==_const.NUMBER) s1=0;
      if (typeof t!==_const.NUMBER) t=0;
      return s+(s1-s)*t;
    },
    interpolateRotation:function Animations_interpolateRotation(s,s1,t) {
      if (typeof s!==_const.NUMBER) s=0;
      if (typeof s1!==_const.NUMBER) s1=0;
      if (typeof t!==_const.NUMBER) t=0;
      return _anims.interpolateSingle(s,s1,t);
    },
    interpolateColor:function Animations_interpolateColor(c,c1,t) {
    ...
    interpolateLinear:function Animations_interpolateLinear(t,b,c,d) {
      if (typeof t!==_const.NUMBER) t=0;
    ...
    interpolateSine:function Animations_interpolateSine(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
    ...
    interpolateQuint:function Animations_interpolateQuint(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    interpolateQuart:function Animations_interpolateQuart(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    interpolateQuad:function Animations_interpolateQuad(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    interpolateExpo:function Animations_interpolateExpo(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    interpolateElastic:function Animations_interpolateElastic(t,b,c,d,a1,p,a) {
      var S;
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
    ...
    interpolateCubic:function Animations_interpolateCubic(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    interpolateCirc:function Animations_interpolateCirc(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    interpolateBounce:function Animations_interpolateBounce(t,b,c,d,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    interpolateBack:function Animations_interpolateBack(t,b,c,d,s,a) {
      if (typeof t!==_const.NUMBER) t=0;
      if (typeof b!==_const.NUMBER) b=0;
      if (typeof c!==_const.NUMBER) c=0;
      if (typeof d!==_const.NUMBER) d=0;
    ...
    choleskyDecomposition:function Animations_choleskyDecomposition(b,c) {
      /// <summary>
    ...
    hermitInterpolate:function Animations_hermitInterpolate(s,x,c) {
      /// <summary>
      /// 
      /// </summary>
      /// <param name="s"></param>
    ...
    calcHermiteFactors:function Animations_calcHermiteFactors(v) {
      /// <summary>
      /// 
      /// </summary>
      /// <param name="v"></param>
  ...
  var Spline=Class.extend({
    ...
    //#region Methods
    splineXY:function Spline_splineXY(t) {
      /// <summary>
      /// 
      /// </summary>
      /// <param name="t"></param>
  ...
  //#endregion
  //#region Animation
  var Animation=$j.classes.Component.extend({
    _ClassName: "Animation",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner);
        //#region Private
        if (!$j.isDOMRenderer()||this instanceof $j.classes.PathAnimation||owner.DOMElement===$j.types.HTMLElements.CANVAS) {
          this.delayTime=0;
          this._time=0;
        ...
        this.running=false;
        this.convertToCSS=$j.isDOMRenderer();
    ...
    setPause:function(newValue){
      ...
      if (newValue!==this.pause){
        ...
        if (this.pause){
          if (this.running) {
            if (!$j.isDOMRenderer()||this instanceof $j.classes.PathAnimation||this._owner.DOMElement===$j.types.HTMLElements.CANVAS) this.stopAtCurrent();
    ...
    setPropertyName:function(newValue) {
      if (typeof newValue!==_const.STRING) return;
      if (newValue!==this.propertyName) this.propertyName=newValue;
    },
    //#endregion
    //#region Methods
    start:function Animation_start(){
      if ($j.tools.isNull(this.control)) return;
      if (!this.convertToCSS||this instanceof $j.classes.PathAnimation||this._owner.DOMElement===$j.types.HTMLElements.CANVAS) {
    ...
    stop:function Animation_stop(){
      if(!this.running) return;
      if ($j.tools.isNull(this.control)) return;
      if (!this.convertToCSS||this instanceof $j.classes.PathAnimation||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
    ...
    loaded:function Animation_loaded(){
      var cssProp=String.empty;
      this._inherited();
      if (!$j.isDOMRenderer()||this instanceof $j.classes.PathAnimation||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
    ...
    processAnimation:function Animation_processAnimation(){},
    stopAtCurrent:function Animation_stopAtCurrent(){
      if(!this.running) return;
      if(this.inverse) this._time=0;
      else this._time=this.duration;
      this.running=false;
    ...
    startTrigger:function Animation_startTrigger(control,trigger){
    ...
    normalizedTime:function Animation_normalizedTime(){
    ...
    processTick:function Animation_processTick(elapsedTime){
      elapsedTime/=1000;
      if(this._owner){
        if (!$j.isDOMRenderer()) {
    ...
    toCSS:function Animation_toCSS(aniName) {
      ...
      ani+=(!$j.tools.isNull(aniName)?aniName:this.name)+String.SPACE+this.duration+"s ";
    ...
    assign:function Animation_assign(source){
  ...
  var ColorAnimation=Animation.extend({
    _ClassName: "ColorAnimation",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner,autoStart);
    ...
    //#region Methods
    start:function ColorAnimation_start() {
      if ($j.tools.isNull(this.control)) return;
      if ($j.tools.isNull(this.control[this.propertyName])) return;
      if (!$j.isDOMRenderer()||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
    ...
    processAnimation:function ColorAnimation_processAnimation() {
      if (!this._owner.checkOwnerVisible()) return;
      if (this.form._loading||this.form._creating) return;
      if ($j.tools.isNull(this.control)) return;
      this._inherited();
      if (!$j.tools.isNull(this.control[this.propertyName])) {
    ...
    assign:function ColorAnimation_assign(source) {
  ...
  var GradientAnimation=Animation.extend({
    _ClassName: "GradientAnimation",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner,autoStart);
    ...
    //#region Methods
    start:function GradientAnimation_start() {
      if ($j.tools.isNull(this.control)) return;
      if (!$j.isDOMRenderer()||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
        if (this.startFromCurrent) {
          if (!$j.tools.isNull(this.control[this.propertyName])) {
    ...
    processAnimation:function GradientAnimation_processAnimation() {
      if ($j.tools.isNull(this.control)) return;
      if (!this.convertToCSS||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {  
        var g;
        if (!$j.isDOMRenderer()) {
    ...
    assign:function GradientAnimation_assign(source) {
  ...
  var FloatAnimation=Animation.extend({
    _ClassName: "FloatAnimation",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner,autoStart);
        this.startValue=0;
    ...
    //#region Methods
    start:function FloatAnimation_start() {
      if ($j.tools.isNull(this.control)) return;
      if (!this.convertToCSS||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
        if (this.startFromCurrent) {
    ...
    stop:function FloatAnimation_stop() {
      this._inherited();
      if (!this.convertToCSS||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
        this.control=null;
      }
    },
    processAnimation:function FloatAnimation_processAnimation() {
      if (!this.convertToCSS||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
        ...
        if (!isNaN(this.control[this.propertyName])) {
          if (this.control._allowUpdate&&!$j.isDOMRenderer()){
    ...
    assign:function FloatAnimation_assign(source) {
  ...
  var RectAnimation=Animation.extend({
    _ClassName: "RectAnimation",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner,autoStart);
    ...
    //#region Methods
    start:function RectAnimation_start() {
      if ($j.tools.isNull(this.control)) return;
      if (!this.convertToCSS||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
        if (this.startFromCurrent) {
          if (!$j.tools.isNull(this.control[this.propertyName])) {
    ...
    processAnimation:function RectAnimation_processAnimation() {
      if ($j.tools.isNull(this.control)) return;
      if (!this.convertToCSS||this.control.DOMElement===$j.types.HTMLElements.CANVAS) {
        if (!$j.isDOMRenderer()) {
          if (!this.control.checkOwnerVisible()) return;
        ...
        if (this.form._loading||this.form._creating) return;
        this._inherited();
        if (!$j.tools.isNull(this.instance)) {
    ...
    assign:function RectAnimation_assign(source) {
  ...
  var BitmapAnimation=Animation.extend({
    _ClassName: "BitmapAnimation",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner,autoStart);
        // Initialization
    ...
    //#region Methods
    processAnimation:function BitmapAnimation_processAnimation() {
      if ($j.tools.isNull(this.control)) return;
      if (!this.control.checkOwnerVisible()) return;
      if (this.form._loading||this.form._creating) return;
      this._inherited();
    ...
    loaded:function BitmapAnimation_loaded() {
    ...
    assign:function BitmapAnimation_assign(source) {
      if (!(source instanceof $j.classes.RectAnimation)) return;
      this._inherited(source);
      this.startValue=source.startValue;
      this.startFromCurrent=source.startFromCurrent;
  ...
  var PathAnimation=Animation.extend({
    _ClassName: "PathAnimation",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner,autoStart);
        // Initialization
    ...
    //#region Methods
    start:function PathAnimation_start() {
      if ($j.tools.isNull(this.control)) return;
      if (this._spline) {
        this._spline=null;
      }
      ...
      if (this._obj) {
        this.startPt.x=this._obj.left;
        this.startPt.y=this._obj.top;
      }
      this._inherited();
    },
    processAnimation:function PathAnimation_processAnimation() {
      if ($j.tools.isNull(this.control)) return;
      if (!$j.isDOMRenderer()) {
        if (!this.control.checkOwnerVisible()) return;
      }
      ...
      if ((this._polygon.length>0) && this._obj) {
        ...
        oldp=new $j.classes.Point(this._obj.left,this._obj.top);
    ...
    assign:function PathAnimation_assign(source) {
      if (!(source instanceof $j.classes.RectAnimation)) return;
      this._inherited(source);
  ...
  //#endregion
  //#region PathSwitcher
  var PathSwitcher=Animation.extend({
    _ClassName: "PathSwitcher",
    init: function(owner,autoStart) {
      if (!$j.tools.isNull(owner)){
        this._inherited(owner,autoStart);
        this.duration=0.001;
    ...
    //#region Methods
    assign:function PathSwitcher_assign(source) {
      if (!(source instanceof $j.classes.RectAnimation)) return;
      this._inherited(source);
  ...
  //#endregion
  $j.classes.register($j.types.categories.ANIMATIONS,Spline,Animation,ColorAnimation,GradientAnimation,FloatAnimation,RectAnimation,BitmapAnimation,PathAnimation,PathSwitcher/*,
                      ,BitmapListAnimation,ColorKeyAnimation,FloatKeyAnimation*/);
  //#region Templates
  var ColorAnimationTpl=["<object id={internalId} data-name='{name}' data-class='ColorAnimation' class='nonVisual' style='{style}' data-designer='false' data-theme='{theme}'>",
                         "<div class='nonVisualImg colorAnimation_design'>",
                         "<div class='nonVisualCaption'>{name}</div>",
                         "</div>",
                         "</object>"].join(String.empty),
      GradientAnimationTpl=["<object id={internalId} data-name='{name}' data-class='GradientAnimation' class='nonVisual' style='{style}' data-designer='false' data-theme='{theme}'>",
                            "<div class='nonVisualImg gradientAnimation_design'>",
                            "<div class='nonVisualCaption'>{name}</div>",
                            "</div>",
                            "</object>"].join(String.empty),
      FloatAnimationTpl=["<object id={internalId} data-name='{name}' data-class='FloatAnimation' class='nonVisual' style='{style}' data-designer='false' data-theme='{theme}'>",
                         "<div class='nonVisualImg floatAnimation_design'>",
                         "<div class='nonVisualCaption'>{name}</div>",
                         "</div>",
                         "</object>"].join(String.empty),
      RectAnimationTpl=["<object id={internalId} data-name='{name}' data-class='RectAnimation' class='nonVisual' style='{style}' data-designer='false' data-theme='{theme}'>",
                        "<div class='nonVisualImg rectAnimation_design'>",
                        "<div class='nonVisualCaption'>{name}</div>",
                        "</div>",
                        "</object>"].join(String.empty),
      BitmapAnimationTpl=["<object id={internalId} data-name='{name}' data-class='BitmapAnimation' class='nonVisual' style='{style}' data-designer='false' data-theme='{theme}'>",
                          "<div class='nonVisualImg bitmapAnimation_design'>",
                          "<div class='nonVisualCaption'>{name}</div>",
                          "</div>",
                          "</object>"].join(String.empty),
      PathAnimationTpl=["<object id={internalId} data-name='{name}' data-class='PathAnimation' class='nonVisual' style='{style}' data-designer='false' data-theme='{theme}'>",
                        "<div class='nonVisualImg pathAnimation_design'>",
                        "<div class='nonVisualCaption'>{name}</div>",
                        "</div>",
                        "</object>"].join(String.empty),
      PathSwitcherTpl=["<object id={internalId} data-name='{name}' data-class='PathSwitcher' class='nonVisual' style='{style}' data-designer='false' data-theme='{theme}'>",
                       "<div class='nonVisualImg pathSwitcher_design'>",
                       "<div class='nonVisualCaption'>{name}</div>",
                       "</div>",
                       "</object>"].join(String.empty);
